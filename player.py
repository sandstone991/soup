...
class Player(GenericEntity):
    ...
    def __init__(self, weapon, screen, x=500, y=500, running=run, idiling=idle, sounds='audio/Player/player_walk.wav', scale=(25, 40), speed=2, health=100, healthFlag=False):
    ...
    def healthBar(self):
        ...
        if self.health > 97.23:
            self.screen.blit(
                self.healthSurface[self.num_of_imgs - 1], self.healthRect[self.num_of_imgs - 1])
        elif self.health < 97.23 and self.health > 94.46:
            self.screen.blit(
                self.healthSurface[self.num_of_imgs - 2], self.healthRect[self.num_of_imgs - 2])
        elif self.health < 94.46 and self.health > 91.69:
            self.screen.blit(
                self.healthSurface[self.num_of_imgs - 3], self.healthRect[self.num_of_imgs - 3])
        elif self.health < 91.69 and self.health > 88.92:
            self.screen.blit(
                self.healthSurface[self.num_of_imgs - 4], self.healthRect[self.num_of_imgs - 4])
        elif self.health < 88.92 and self.health > 86.15:
            self.screen.blit(
                self.healthSurface[self.num_of_imgs - 5], self.healthRect[self.num_of_imgs - 5])
        elif self.health < 86.15 and self.health > 83.38:
            self.screen.blit(
                self.healthSurface[self.num_of_imgs - 6], self.healthRect[self.num_of_imgs - 6])
        elif self.health < 83.38 and self.health > 80.61:
            self.screen.blit(
                self.healthSurface[self.num_of_imgs - 7], self.healthRect[self.num_of_imgs - 7])
        elif self.health < 80.61 and self.health > 77.84:
            self.screen.blit(
                self.healthSurface[self.num_of_imgs - 8], self.healthRect[self.num_of_imgs - 8])
        elif self.health < 77.84 and self.health > 75.07:
            self.screen.blit(
                self.healthSurface[self.num_of_imgs - 9], self.healthRect[self.num_of_imgs - 9])
        elif self.health < 75.07 and self.health > 72.3:
            self.screen.blit(
                self.healthSurface[self.num_of_imgs - 10], self.healthRect[self.num_of_imgs - 10])
        elif self.health < 72.3 and self.health > 69.53:
            self.screen.blit(
                self.healthSurface[self.num_of_imgs - 11], self.healthRect[self.num_of_imgs - 11])
        elif self.health < 69.53 and self.health > 66.76:
            self.screen.blit(
                self.healthSurface[self.num_of_imgs - 12], self.healthRect[self.num_of_imgs - 12])
        elif self.health < 66.76 and self.health > 63.99:
            self.screen.blit(
                self.healthSurface[self.num_of_imgs - 13], self.healthRect[self.num_of_imgs - 13])
        elif self.health < 63.99 and self.health > 61.22:
            self.screen.blit(
                self.healthSurface[self.num_of_imgs - 14], self.healthRect[self.num_of_imgs - 14])
        elif self.health < 61.22 and self.health > 58.45:
            self.screen.blit(
                self.healthSurface[self.num_of_imgs - 15], self.healthRect[self.num_of_imgs - 15])
        elif self.health < 58.45 and self.health > 55.68:
            self.screen.blit(
                self.healthSurface[self.num_of_imgs - 16], self.healthRect[self.num_of_imgs - 16])
        elif self.health < 55.68 and self.health > 52.91:
            self.screen.blit(
                self.healthSurface[self.num_of_imgs - 17], self.healthRect[self.num_of_imgs - 17])

        elif self.health < 52.91 and self.health > 50.14:
            self.screen.blit(
                self.healthSurface[self.num_of_imgs - 18], self.healthRect[self.num_of_imgs - 18])
        elif self.health < 50.14 and self.health > 47.37:
            self.screen.blit(
                self.healthSurface[self.num_of_imgs - 19], self.healthRect[self.num_of_imgs - 19])
        elif self.health < 47.37 and self.health > 44.6:
            self.screen.blit(
                self.healthSurface[self.num_of_imgs - 20], self.healthRect[self.num_of_imgs - 20])
        elif self.health < 44.6 and self.health > 41.83:
            self.screen.blit(
                self.healthSurface[self.num_of_imgs - 21], self.healthRect[self.num_of_imgs - 21])
        elif self.health < 41.83 and self.health > 39.06:
            self.screen.blit(
                self.healthSurface[self.num_of_imgs - 22], self.healthRect[self.num_of_imgs - 22])
        elif self.health < 39.06 and self.health > 36.29:
            self.screen.blit(
                self.healthSurface[self.num_of_imgs - 23], self.healthRect[self.num_of_imgs - 23])
        elif self.health < 36.29 and self.health > 33.52:
            self.screen.blit(
                self.healthSurface[self.num_of_imgs - 24], self.healthRect[self.num_of_imgs - 24])
        elif self.health < 33.52 and self.health > 30.75:
            self.screen.blit(
                self.healthSurface[self.num_of_imgs - 25], self.healthRect[self.num_of_imgs - 25])
        elif self.health < 30.75 and self.health > 27.98:
            self.screen.blit(
                self.healthSurface[self.num_of_imgs - 26], self.healthRect[self.num_of_imgs - 26])
        elif self.health < 27.98 and self.health > 25.21:
            self.screen.blit(
                self.healthSurface[self.num_of_imgs - 27], self.healthRect[self.num_of_imgs - 27])
        elif self.health < 25.21 and self.health > 22.44:
            self.screen.blit(
                self.healthSurface[self.num_of_imgs - 28], self.healthRect[self.num_of_imgs - 28])
        elif self.health < 22.44 and self.health > 19.67:
            self.screen.blit(
                self.healthSurface[self.num_of_imgs - 29], self.healthRect[self.num_of_imgs - 29])
        elif self.health < 19.67 and self.health > 16.9:
            self.screen.blit(
                self.healthSurface[self.num_of_imgs - 30], self.healthRect[self.num_of_imgs - 30])
        elif self.health < 16.9 and self.health > 14.13:
            self.screen.blit(
                self.healthSurface[self.num_of_imgs - 31], self.healthRect[self.num_of_imgs - 31])
        elif self.health < 14.13 and self.health > 11.36:
            self.screen.blit(
                self.healthSurface[self.num_of_imgs - 32], self.healthRect[self.num_of_imgs - 32])
        elif self.health < 11.36 and self.health > 8.59:
            self.screen.blit(
                self.healthSurface[self.num_of_imgs - 33], self.healthRect[self.num_of_imgs - 33])

        elif self.health < 8.59 and self.health > 5.82:
            self.screen.blit(
                self.healthSurface[self.num_of_imgs - 34], self.healthRect[self.num_of_imgs - 34])
        elif self.health < 5.82 and self.health > 3.05:
            self.screen.blit(
                self.healthSurface[self.num_of_imgs - 35], self.healthRect[self.num_of_imgs - 35])
        elif self.health < 3.05:
            self.screen.blit(
                self.healthSurface[self.num_of_imgs - 36], self.healthRect[self.num_of_imgs - 36])
